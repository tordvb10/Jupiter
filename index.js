...
const array = {
  ...
  "main #Jupiter p": {
    "norsk": 'Jupiter har fått sitt navn fra kongen av de romerske gudene, og er den største planeten i solsystemet vårt. Hvis jorden var av størrelse av atomet nikkel, ville Jupiter være på størrelse med en basketball, i følge NASA.',
    "english": 'Jupiter has got its name from the king of the Roman gods, and it is the largest planet in the our solar system. If the earth was at the size of the atom nickel, Jupiter would be on the size of a basketball, according to NASA.'
  },
  ...
  "main #Atmosfæren #Atmosfære-avsnitt-1": {
    "norsk": 
      `Jupiters observerbare atmosfære er veldig tynn. Like tynn som et
              epleskall på et eple. Atmosfæren er den delen av en planet i
              gassform man kan observere med det blåtte øye. <br /><br />Skallet
              har et veldig fascinerende mønster, det kommer av vortex. Vortex
              ...
              mønsteret er tilsvarende symmertrisk fra ekvator og til hver sin
    ...
    "english": `Jupiters atmosphere is seemingly thin. Just as thin as the 
              ...
              gaseous form that can be observed by the naked eye.`
  },
};
